    ...
    <section className="relative py-28 bg-gradient-to-b from-slate-50 via-white to-slate-100 font-inter">
      ...
      <div className="relative max-w-[1600px] mx-auto px-6">
        ...
        >
          ...
          <p className="text-[17px] leading-[1.75] max-w-3xl mx-auto font-bold text-black">
            Delivering engineered vehicle body fabrication solutions designed
            for heavy-duty commercial, infrastructure, and public service
            applications.
          </p>
        </motion.div>
          ...
          {Industry.map((item, index) => (
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <p className="text-gray-600 text-[18px] font-semibold leading-[1.7] mb-7">
                  {item.desc}
                </p>

                <h4 className="text-gray-900 text-[19px] font-bold uppercase tracking-wider mb-3">
                  Key Services:
                </h4>
                ...
                <ul className="space-y-2 mb-6">
                  {item.features.map((feature, i) => (
                    <li
                      key={i}
                      className="text-[18px] font-semibold text-gray-700 flex items-start gap-3"
                    >
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-gradient-to-r from-orange-500 to-red-500 flex-shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
...
export default Comercialindristy;
